...
import database.WorkoutRoutineDAO;
import objects.*;
...
//        System.out.println("Search 'Morning Workout': " + app.findByName("Morning Workout"));
    ...
    public static void dbTest() {
        ...
        User user = new User(0, "Assylnaz", "Parymbek", "assylnaz@mail.com", "87763360848");
        userDAO.add(user);

        WorkoutRoutine r1 = new WorkoutRoutine(0, "Morning", "Cardio", 400, "45 min", true);
        workoutDAO.add(r1, 1);

        System.out.println("Users: " + userDAO.getAll());
        System.out.println("Workouts: " + workoutDAO.getByUserId(1));
    }
}
